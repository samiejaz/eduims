...
const DevelopmentTasksManagement = () => {
  ...
  const {
    ...
    queryFn: () =>
      fetchDevelopmentTasks(user.userID, method.getValues("EmployeeID")),
    initialData: [],
    ...
    <div className="mt-5 px-3">
      <FormRow>
        ...
        >
          ...
          <Button
            label="UPDATE FOLLOWING SEQUENCE"
            severity="success"
            className="rounded"
            style={{
              height: 12,
...
export default DevelopmentTasksManagement
